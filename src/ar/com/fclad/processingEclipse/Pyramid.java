...
public class Pyramid {
	...
	PVector[] v = new PVector[nbPoints]; // the 5 relative coordinates of the pyramid as an object
	int[] c = new int[nbPoints]; // the colors for each coordinate
	...
	public Pyramid(PApplet p, float pRadius) {
		parent = p;
